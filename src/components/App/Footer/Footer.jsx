    ...
    <footer className="footer">
      ...
      <div className="footer__right">
        ...
        <div className="footer__social">
          ...
          >
            <svg className="footer__social-icon" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path d="M0 1.432C0 .641.657 0 1.468 0h17.064C19.343 0 20 .641 20 1.432v17.136C20 19.359 19.343 20 18.532 20H1.468C.657 20 0 19.359 0 18.568V1.432zM6.007 16.8V7.717H3.01V16.8h2.997zm-1.498-10.31c1.044 0 1.694-.692 1.694-1.557-.02-.883-.65-1.557-1.675-1.557-1.025 0-1.694.674-1.694 1.557 0 .865.65 1.557 1.655 1.557h.02zm5.63 10.31v-5.07c0-.27.02-.539.099-.731.217-.538.71-1.096 1.54-1.096 1.087 0 1.52.83 1.52 2.044V16.8h2.997v-4.985c0-2.773-1.48-4.062-3.454-4.062-1.619 0-2.33.905-2.723 1.52H9.14V7.717H6.142c.04.846 0 9.083 0 9.083h2.997z" fill="currentColor"/>
            </svg>
          </a>
        </div>
      </div>
